import { BarberDto, ListResponseDto, UserDto, AdminLoginResponseDto } from '../../dto/admin.dto';
...
export interface IAdminService {
    ...
    listUsers(search: string,page: number,limit: number): Promise<{ response: ListResponseDto<UserDto>, status: number;}>;
    listBarbers(search: string,page: number,limit: number): Promise<{ response: ListResponseDto<BarberDto>, status: number;}>;
