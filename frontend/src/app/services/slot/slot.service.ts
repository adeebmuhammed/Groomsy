...
export class SlotService {
  ...
  createSlot(barberId: string, data: SlotDto): Observable<{ response: SlotDto; message: string }> {
  ...
  updateSlot(slotId: string, data: SlotDto): Observable<{ response: SlotDto; message: string }> {
