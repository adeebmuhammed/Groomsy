...
@Component({
  ...
  imports: [ AdminHeaderComponent,AdminFooterComponent,AdminSidebarComponent,CommonModule,ServiceFormComponent,AdminTableComponent],
  ...
  { key: 'price', label: 'Price' },
    ...
    onModalSubmit(payload: any): void {
      if (this.selectedServiceId) {
        this.serviceService.edit(this.selectedServiceId, payload).subscribe({
          next: () => {
            Swal.fire({
              icon: 'success',
